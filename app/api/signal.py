...
DEFAULT_TICKERS: List[TickerInfo] = [
    ...
    TickerInfo(ticker="MSFT", name="Microsoft Corporation", type="Stock", tags=["Growth"]),
    TickerInfo(ticker="AMZN", name="Amazon.com, Inc.", type="Stock", tags=["Growth"]),
    TickerInfo(ticker="GOOG", name="Alphabet Inc.", type="Stock", tags=["Growth"]),
    ...
    TickerInfo(ticker="NVDA", name="NVIDIA Corporation", type="Stock", tags=["Growth"]),
    TickerInfo(ticker="TSLA", name="Tesla, Inc.", type="Stock", tags=["Growth"]),
